...
import frc.robot.commands.autonomous.ShootAndDriveForwardAuto;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoChooser.setDefaultOption("Shoot and Drive Forward", new ShootAndDriveForwardAuto(drivetrain, shooter, indexer));
