...
public class SwerveModuleMK3 {
  ...
  private static final double kAngleD = (Constants.kAngleD);
  ...
  public SwerveModuleMK3(TalonFX driveMotor, TalonFX angleMotor, CANCoder canCoder, Rotation2d offset) {
    ...
    //TRAINING WHEELS- Cap max speed while training
    driveMotor.configPeakOutputForward(.50, 30);
    driveMotor.configPeakOutputReverse(-.50, 30); 
