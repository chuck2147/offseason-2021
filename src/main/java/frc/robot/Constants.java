...
public final class Constants {
    ...
    public static final NTValue TEST_UPPER = new NTValue((double) 10000, "Shooter Test Upper");
    public static final NTValue TEST_LOWER = new NTValue((double) 0, "Shooter Test Lower");

    public static final NTValue SHOOTER_TRIANGLE_UPPER = new NTValue((double) -5000, "Shooter Triangle Upper");
    public static final NTValue SHOOTER_TRIANGLE_LOWER = new NTValue((double) 12000, "Shooter Triangle Lower");

    public static final NTValue SHOOTER_BEHIND_LINE_UPPER = new NTValue((double) 5000, "Shooter Behind Line Upper");
    public static final NTValue SHOOTER_BEHING_LINE_LOWER = new NTValue((double) 12000, "Shooter Behind Line Lower");
    
    public static final NTValue FRONT_OF_TRENCH_UPPER = new NTValue((double) 300, "Shooter Front Of Trench Upper"); 
    public static final NTValue FRONT_OF_TRENCH_LOWER = new NTValue((double) 10400, "Shooter Front OF Trench Lower"); 
   

    public static final NTValue SHOOTER_FAR_UPPER = new NTValue((double) 14000, "Shooter Far Upper"); 
    public static final NTValue SHOOTER_FAR_LOWER = new NTValue((double) 18700, "Shooter Far Lower"); 

    public static final NTValue NEW_UPPER = new NTValue((double) 16000, "Shooter New Upper"); 
    public static final NTValue NEW_LOWER = new NTValue((double) 19000, "Shooter New Lower");
